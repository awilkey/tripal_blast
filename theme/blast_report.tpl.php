...
//            && $blast_job->blastdb->cvitjs_enabled == '1') {
    ...
    <?php
      drupal_add_js(array('blast_ui'=> array('dataset' => $blast_job -> blastdb -> db_name)),'setting');		
      drupal_add_js(array('blast_ui'=> array('gff' => '../../' . $blast_job->files->result->gff)),'setting');		
      $base = drupal_get_path('module','blast_ui').'/js/cvitjs/js/lib/';
